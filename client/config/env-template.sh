...
#
# Usage:
#   cp config/env-template.sh .env.audit
...
export REDIS_USERNAME=""   # provided during onboarding (format: project-{name})
export REDIS_PASSWORD=""   # provided during onboarding
